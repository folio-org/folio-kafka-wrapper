...
public class TenantIdCheckInterceptor implements ProducerInterceptor<String, String> {
  ...
  protected static final String TENANT_ID_ERROR_MESSAGE =
    "Kafka record does not have a tenant identifying header. "
  ...
  public ProducerRecord<String, String> onSend(ProducerRecord<String, String> producerRecord) {
    ...
    if (!isTenantIdHeaderExist) {
      LOGGER.error(TENANT_ID_ERROR_MESSAGE, producerRecord.topic());
    }
